...
public class OmnityCobraHelper : OmnityTabbedFeature {
    ...
    private System.Collections.IEnumerator CoLoad(Omnity myOmnity) {
        ...
        if (isStereoRig(myOmnity)) {
            ...
            myScreenShapeLeft.name = "CobraScreen Left";
            myScreenShapeLeft.layer = 29;
        ...
        myScreenShapeRight.name = isStereoRig(myOmnity) ? "CobraScreen Right" : "CobraScreen";
        myScreenShapeRight.layer = 30;
    ...
    public void ReconnectTextures(Omnity anOmnity, Texture tt) {
        ...
        switch (textureSource) {
            ...
            case TextureSource.TextureFromApplication:
                if (myScreenShapeRight.renderer != null) {
                    myScreenShapeRight.renderer.sharedMaterial.mainTexture = tt;
                    if (getLatestFlipY()) {
                        Debug.Log("ADD flip in shader");
                        myScreenShapeRight.renderer.sharedMaterial.mainTextureOffset = new Vector2(0, 1);
                        myScreenShapeRight.renderer.sharedMaterial.mainTextureScale = new Vector2(1, -1);
                    } else {
                        myScreenShapeRight.renderer.sharedMaterial.mainTextureOffset = new Vector2(0, 0);
                        myScreenShapeRight.renderer.sharedMaterial.mainTextureScale = new Vector2(1, 1);
                    }
                }
                break;
