...
#pragma warning restore 414
        ...
        private void _Enable() {
            ...
            if (!Application.isPlaying) {
                UnityEditor.EditorApplication.update -= _LateUpdate;
                UnityEditor.EditorApplication.update += _LateUpdate;
            }
#endif
        ...
        public TextureInfo getTextureInfo(string sharingName, bool stayquite = false) {
            ...
            if (sharingName != Spout.fakeName && !stayquite) Debug.Log(String.Format("sharing name {0} not found", sharingName));
